...
const options = {
    key: fs.readFileSync('/etc/letsencrypt/live/seu-dominio.com/privkey.pem'), // Caminho para a chave privada
    cert: fs.readFileSync('/etc/letsencrypt/live/seu-dominio.com/fullchain.pem') // Caminho para o certificado
};
...
const PORT_HTTP = 80; // Porta padrão para HTTP
